...
export function useKickOff() {
	...
	const knightBlack = (
		<Knight key={'knightBlack'} size={'2.3em'} color={'black'} draggable={true} outputRef={outputRef} />
	);
	const bishopBlack = (
		<Bishop key={'bishopBlack'} size={'2.3em'} color={'black'} draggable={true} outputRef={outputRef} />
	);
	...
	const knightWhite = (
		<Knight key={'knightWhite'} size={'2.3em'} color={'white'} draggable={true} outputRef={outputRef} />
	);
	const bishopWhite = (
		<Bishop key={'bishopWhite'} size={'2.3em'} color={'white'} draggable={true} outputRef={outputRef} />
	);
